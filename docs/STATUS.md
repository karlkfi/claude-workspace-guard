...
| <a id="Q83"></a>Q83 | Count denies in the friction report, which the attachment stream never carries | `infra` | 🔲 | S | Measured 2026-08-21, `--since all`: 58,194 decisions, allow 56,796, ask 1,398, **deny 0** — yet host-temp deny is the default. Recover them from tool-result text on the new `workspace-guard: ` opener ([how](development/measuring-friction.md)). |
