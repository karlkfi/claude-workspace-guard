...
| <a id="Q83"></a>Q83 | Count denies in the friction report, which the attachment stream never carries | `infra` | 🔲 | S | Measured 2026-08-21: 58,194 decisions, ask 1,398, **deny 0** — yet host-temp deny is the default. Recover from tool-result text ([how](development/measuring-friction.md)). The `workspace-guard: ` opener marks a block, not a deny: asks carry it too. |
